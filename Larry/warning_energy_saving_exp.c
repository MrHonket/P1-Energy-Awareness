...
double warning_energy_saving(user User, data *Data){
    ...
    one_consumption = Data->meter.value; //Skal findes i Data.meter.unit el. value men kan IKKE tilgås sådan grundet det er en pointer til et struct.
